...
class LineCounter:
    """Track-aware line crossing counter with one-count-per-id policy."""
    ...
    def _line_side(self, point: Point) -> float:
        x, y = point
        x1, y1 = self.p1
        x2, y2 = self.p2
    ...
    def update(self, tracks: List[Dict]) -> bool:
        ...
        for track in tracks:
            ...
            # For horizontal line left->right: top->down maps to positive->negative.
            if prev_side > side:
